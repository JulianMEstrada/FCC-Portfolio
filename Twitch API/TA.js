...
var url2 = 'https://wind-bow.glitch.me/twitch-api/streams/freecodecamp';

$.getJSON(url2,function(data2){

if (data2.stream===null)
$('#freecodecamp').html('FreeCodeCamp is Currently Offline! ');

else {$('#freecodecamp').html('FreeCodeCamp is Currently Online! ');}
...
$("#userInfo").prepend("<div class = 'row'>"+"<div class='col'>"+"<a target='_blank' href="+link+"><img src=' "+logo+"'alt='img/Twitch.png'</a>"+"</div>"+"<div class='col'>"+name+"</div>"+"<div class='col'>"+status+"<div class='last'></div></div>");
}
});}// DATA 0 and URL 0
